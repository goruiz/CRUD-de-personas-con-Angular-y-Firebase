...
export class DataService {
    ...
    cargarPersonas(){
        return this.httpClient.get('https://personas-610ed-default-rtdb.firebaseio.com/datos.json');
    }

    //Guarda todo el arreglo de personas 
    guardarPersonas(personas: Persona[]) {
        this.httpClient.put('https://personas-610ed-default-rtdb.firebaseio.com/datos.json', personas)
            .subscribe(
                (response) => {
    ...
    modificarPersona(index:number, persona: Persona){
        let url: string;
        url = 'https://personas-610ed-default-rtdb.firebaseio.com' + '/datos/' + index + '.json';
